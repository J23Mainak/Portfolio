    ...
    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
      ...
      <div className="space-y-3 flex-1">
        <p className="text-terminal-foreground">
          Hello there! 👋 I'm <span className="font-semibold">Mainak </span>, a
        ...
        <p className="text-terminal-foreground">
          My work spans research on computer vision tasks for medical
          diagnosis, building full-stack products like EyeCare & InterviewAI, and
          doing competitive programming on Codeforces and CodeChef. When I’m not
