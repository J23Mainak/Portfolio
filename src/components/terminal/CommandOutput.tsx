    ...
    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
      ...
      <div className="space-y-3 flex-1">
        <p className="text-terminal-foreground">
          I'm <span className="font-semibold">Mainak Jana</span>, a Computer
          Science and Engineering undergraduate at Birla Institute of
          Technology, Mesra (CGPA 9.12). I enjoy building end-to-end systems
          that combine deep learning, LLMs, and scalable web applications.
        </p>
        <p className="text-terminal-foreground">
          My work spans research on channel-attention CNNs for medical
          diagnosis, full-stack products like EyeCare and InterviewAI, and
